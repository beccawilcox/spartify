...
MQTT_CLIENT_ID = "lamp_spartify"

class SpartifyApp(App):
    album_image = StringProperty("images/albumCovers/Before You Go.JPG.png")
    _updated = False
    _updatingUI = False
    ...
    def _set_title(self, value):
        self.album_image = value + ".PNG"

    album_image = StringProperty(_get_title, _set_title, bind = ['album_image'])
    ...
    def on_start(self):
        ...
        # replace with the binding to the skip pause and play buttons
